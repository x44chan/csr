		...
		echo '<div style = "min-height: 400px; text-align: center;" >		
			<div class = "container" style = "margin-top: -40px;">
				<div class = "row" style="margin-bottom: 10px;">
					<div class="col-xs-12">
				    	<div align = "left">
							<i><h3 style = "text-decoration: underline;">PC Service Report</h3></i>
							'.$notifs.'
						</div>
				    </div>
				</div>
			...
			<form class="form-inline" action = "" role = "form" method = "post">
				<div class = "row ">
					<div class="col-xs-12"align = "center">
						...
						<input required type = "text" style = "width: 300px;" name  = "pcname" class = "form-control" name = "datefr" placeholder ="Enter PC Name to Search"/>									
					</div>
				</div>
				<div class = "row">
					<div class = "col-xs-12">
						...
						<input type = "date" class = "form-control" name = "datefr" />					
					...
					<div class = "row">
						<div class="col-xs-12">
			    			<div align = "center"class="page-header">
								<h2 style = "text-decoration: underline;">PC Service Report</h2>
								'.$notifs.'
							</div>
			    		</div>
					</div>';
